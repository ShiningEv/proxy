/*
** automatic proxy configuration V2.1 for 10.158.100.1 from proxyconf.glb.nsn-net.net (10.158.55.18)
*/
function FindProxyForURL(url, host) {
 var proxy="PROXY fihel1d-proxy.emea.nsn-net.net:8080; PROXY defra1c-proxy.emea.nsn-net.net:8080;";
 var proxy1="PROXY 10.144.1.10:8080;";

 if ( shExpMatch(host, "*.163.com") ) { 'PROXY 79.137.38.20:80'; }

 if ( shExpMatch(host, "localhost") ) { return "DIRECT"; }
 if ( shExpMatch(host, "localhost.*") ) { return "DIRECT"; }
 if ( shExpMatch(host, "127.0.0.*") ) { return "DIRECT"; }
 if ( isPlainHostName(host) ) { return "DIRECT"; }
 if ( isInNet(myIpAddress(), "192.168.0.102", "255.255.255.0")) { return "DIRECT"; }
 if ( isInNet(myIpAddress(), "10.255.32.0", "255.255.240.0") || 
     isInNet(myIpAddress(), "10.0.0.0", "255.0.0.0")) { return proxy1; }
 ...
 if ( dnsDomainIs(host, ".nbnco.net.au") ) {  return "PROXY 203.17.66.133:8000;PROXY 203.17.66.134:8000"; }
 ...
 if ( dnsDomainIs(host, ".pvnetsolutions.com") ) { dnsResolve(host+'.bf.nsn-intra.net'); return "DIRECT"; }
 if ( dnsDomainIs(host, ".nextenso.com") ) { dnsResolve(host+'.bf.nsn-intra.net'); return "DIRECT"; }
 ...
 if ( dnsDomainIs(host, ".shrnetwrk.com") ) { dnsResolve(host+'.bf.nsn-intra.net'); return "DIRECT"; }
 ...
 if ( dnsDomainIs(host, ".xylan.com") ) { dnsResolve(host+'.bf.nsn-intra.net'); return "DIRECT"; }
